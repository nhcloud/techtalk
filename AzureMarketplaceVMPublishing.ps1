Function Copy-AzMarketPlaceVhd([string]$storageAccount,[string]$storageKey,[string]$srcUri,[string]$destStorageAccount,[string]$destStorageKey,[string]$destContainerName)
{
    ...
    $blob1 = Start-AzureStorageBlobCopy -srcUri $srcUri -DestContainer $destContainerName -DestBlob "interchange3.4.1704.0351.vhd" -SrcContext $sourceContext -DestContext $destContext
